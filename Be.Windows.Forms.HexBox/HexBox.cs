...
namespace Be.Windows.Forms
{
    ...
    public class HexBox : Control
    {
        ...
        [Description("Occurs when a highlight is added or removed")]
        ...
        public HexBox()
        {
            ...
            _highlights = new HighlightCollection(this);
        }
        ...
        public long Find(FindOptions options)
        {
            ...
            {
                startIndex = (this.SelectionStart + this.SelectionLength);
            }
            else if (options.Direction == FindDirection.Backward)
            {
                startIndex = this.SelectionStart - 1;
            }
            int direction = (options.Direction == FindDirection.Backward) ? -1 : 1;
            ...
            for (long pos = startIndex; pos < _byteProvider.Length & pos >= 0; pos += direction)
            {
                if (_abortFind)
                    return -2;
        ...
        void PaintHexAndStringView(Graphics g, long startByte, long endByte)
        {
            ...
            for (long i = startByte; i < intern_endByte + 1; i++)
            {
                ...
                {
                    // TODO: Draws a selection square and a string view string.
                ...
                else
                {
                    ...
                    if (highlight != null)
                    {
                        ...
                        g.DrawString(s, Font, highlight.Foreground, byteStringPointF, _stringFormat);
                    }
                    else
                    {
                        // TODO: Draws a string view string.
        ...
        // TODO: 'S' controls selection width for string view.
        ...
        public class HighlightCollection : IList<Highlight>
        {
            ...
            public bool Contains(Highlight item)
            {
                return _highlights.Contains(item);
            }

            public void CopyTo(Highlight[] array, int arrayIndex)
            {
                _highlights.CopyTo(array, arrayIndex);
            }
